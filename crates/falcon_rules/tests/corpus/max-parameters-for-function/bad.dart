...
void create(String a, String b, int c, double d, bool e, List<String> f) { /* expect: max-parameters-for-function */
  print(a);
  print(b);
  print(c);
  print(d);
...
class Example {
  void process(int p1, int p2, int p3, int p4, int p5, int p6, int p7) { /* expect: max-parameters-for-function */
    print(p1);
    print(p2);
  }

  // Another method with 8 parameters
  String buildString(String a, String b, int c, double d, bool e, List<String> f, Map<String, int> g, Set<int> h) { /* expect: max-parameters-for-function */
